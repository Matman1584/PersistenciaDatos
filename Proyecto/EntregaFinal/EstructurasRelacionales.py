...
# tabla DocumentoIDs
cursor.execute('''CREATE TABLE IF NOT EXISTS DocumentoIDS (
    ...
    FOREIGN KEY (empl_Gerente_ID) REFERENCES DocumentoIDS(empl_ID),
...
# Insert data into DocumentoIDS
cursor.executemany('INSERT INTO DocumentoIDS (empl_ID, empl_primer_nombre, empl_segundo_nombre, empl_email, empl_fecha_nac, empl_sueldo, empl_comision, empl_cargo_ID, empl_Gerente_ID, empl_dpto_ID) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [
